...
import unittest
from unittest.mock import patch, mock_open, MagicMock, Mock #type: ignore
from src.constants import SCHEMA_PATH #type: ignore
from src.utils import (dynamic_threshold,load_yaml,save_yaml, schema_saver, train_test_splitter,
                       eval_metrics, stage_1_processing_function, DB_data_loader)
import numpy as np
...
def test_stage_2_processing(data_stage_2):
    assert data_stage_2.isna().any().any() == False
